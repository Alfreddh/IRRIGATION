...
SECRET_KEY = 'django-insecure-se#@7gd#773_*%05z_4*jpt+jfq=to)nls)*ikuoia1_d_uyu6'
...
DJOSER = {
    ...
    "SERIALIZERS": {
        ...
        "user": "accounts.serializers.UsersUpdateSerializer",
        "current_user": "accounts.serializers.UsersUpdateSerializer",
